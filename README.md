simpler-sidebar
===
[![GitHub version](https://img.shields.io/badge/version-1.4.6-brightgreen.svg)](https://github.com/dcdeiv/simpler-sidebar/releases/latest)
[![Bower version](https://img.shields.io/badge/bower-1.4.6-brightgreen.svg)](https://github.com/dcdeiv/simpler-sidebar)
[![npm version](https://img.shields.io/badge/npm-1.4.6-brightgreen.svg)](https://www.npmjs.com/package/simpler-sidebar)
...
## Release History
* **v1.4.6** (2016-02-16) - fix JSHint and coding style.
* **v1.4.5** (2016-01-22) -
  * Update copyright.
